...
public class FirstPersonDrifter: MonoBehaviour
{
    ...
    public ControllerColliderHit hitter;
    ...
    void OnControllerColliderHit (ControllerColliderHit hit) 
    {
        ...
        {
            Debug.Log("Commencing boosting of speeds...");
